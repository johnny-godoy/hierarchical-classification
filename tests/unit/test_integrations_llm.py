...
class TestLLMNodeClassifier:
    def test_correct_label_gets_probability_one(self, mock_litellm, node_animals) -> None:
    ...
    def test_dtype_is_float32(self, mock_litellm, node_animals) -> None:
    ...
    def test_unrecognised_label_returns_all_zeros(self, mock_litellm, node_animals) -> None:
    ...
    def test_whitespace_stripped_from_response(self, mock_litellm, node_animals) -> None:
    ...
    def test_length_equals_number_of_children(self, mock_litellm, node_animals) -> None:
        mock_litellm.completion.return_value = _make_litellm_response("cat")
        clf = LLMNodeClassifier()
    ...
    def test_completion_kwargs_forwarded(self, mock_litellm, node_animals) -> None:
        mock_litellm.completion.return_value = _make_litellm_response("cat")
    ...
    def test_correct_messages_sent_to_litellm(self, mock_litellm, node_animals) -> None:
        mock_litellm.completion.return_value = _make_litellm_response("cat")
        clf = LLMNodeClassifier()
        clf.predict_proba("meow", node_animals)
        _, call_kwargs = mock_litellm.completion.call_args
    ...
    def test_model_name_forwarded_to_litellm(self, mock_litellm, node_animals) -> None:
        mock_litellm.completion.return_value = _make_litellm_response("cat")
    ...
    def test_single_child(self, mock_litellm) -> None:
